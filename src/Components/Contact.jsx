  ...
  return (
    <>
      <div className="wrapper w-full h-[500px] bg-DarkColor relative">
        ...
        <div className="main">
          <div className="main_wrapper flex flex-wrap justify-center items-center m-[150px] sm:m-[100px]">
            ...
            <a className="m-[20px]" href="tel:+917523997372">
        ...
        <div className="divider_title flex justify-center items-center">
          ...
          <div className="title text-PrimiaryColor  text-[60px] josefin-sans-bold absolute bottom-[-40px] sm:bottom-[-26px] flex space-x-10 sm:text-[40px] sm:space-x-[15px] ">
            ...
            <div className="icon ">
            <a href="https://www.linkedin.com/in/sankalpsingh03/"><LinkedIn className="icon"  style={{fontSize:`${iconSize}px`}}/></a>
            </div>
            <div className="icon ">
            <a href="https://leetcode.com/u/singhsankalp997/"><Code className="icon"  style={{fontSize:`${iconSize}px`}}/></a>
            </div>
          </div>
      ...
      <div style={{display:"flex", gap:"10px"}} className="footer__copyright w-full h-full bg-ExtraDarkColor flex justify-center items-center">
          <div style={{display:"flex", gap:"10px"}}  className="copyright__content text-[15px] sm:text-[12px] text-LightPrimaryColor josefin-sans-light ">&copy; 2024, <a href="https://www.linkedin.com/in/sankalpsingh03/" title="">Sankalp Singh</a>. All rights reserved.</div>
        </div>
    </>
  );
};
