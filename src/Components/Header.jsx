    ...
    <div className='wrapper w-[100vw] h-[160px] bg-DarkColor py-6 px-6 pr-[300px] sm:pr-[15px] sm:p-[15px] overflow-hidden'>
      <div className="inner-wrapper w-full h-full flex justify-between items-center space-x-12 sm:space-x-8">
        ...
        {!screen && <div className="links flex justify-between flex-4">
          <a className="text-sm md:text-base lg:text-[22px] sm:text-[18px] text-PrimiaryColor josefin-sans-bold hover:josefin-sans-bold hover:text-PrimiaryColor transition-colors duration-500" href="#toolbox"> Skills </a>
          <a className="text-sm md:text-base lg:text-[22px] sm:text-[18px] text-LightPrimaryColor josefin-sans-bold hover:josefin-sans-bold hover:text-PrimiaryColor transition-colors duration-500" href="#craft"> Projects </a>
